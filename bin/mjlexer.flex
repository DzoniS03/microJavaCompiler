...
"<="					{ return new_symbol(sym.LESSEREQUAL, yytext()); }
...
"("						{ return new_symbol(sym.OPAREN, yytext()); }
")"						{ return new_symbol(sym.CPAREN, yytext()); }
"["						{ return new_symbol(sym.OBRACKET, yytext()); }
"]"						{ return new_symbol(sym.CBRACKET, yytext()); }
"{"						{ return new_symbol(sym.OBRACE, yytext()); }
"}"						{ return new_symbol(sym.CBRACE, yytext()); }
