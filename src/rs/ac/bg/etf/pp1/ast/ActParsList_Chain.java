...
public class ActParsList_Chain extends ActParsList {

    private ActParsStart ActParsStart;
    private ActPar ActPar;
    private AdditionalActPars AdditionalActPars;

    public ActParsList_Chain (ActParsStart ActParsStart, ActPar ActPar, AdditionalActPars AdditionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsList_Chain(\n");
