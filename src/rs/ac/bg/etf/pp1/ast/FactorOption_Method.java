...
public class FactorOption_Method extends FactorOption {

    private Designator Designator;
    private ActParsList ActParsList;

    public FactorOption_Method (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorOption_Method(\n");
