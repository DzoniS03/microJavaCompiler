...
public class AddopTermList_Addop extends AddopTermList {

    private AddopTermList AddopTermList;
    private Addop Addop;
    private Term Term;

    public AddopTermList_Addop (AddopTermList AddopTermList, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermList_Addop(\n");
