...
public class AdditionalFormPars_COMMA extends AdditionalFormPars {

    private FormPar FormPar;
    private AdditionalFormPars AdditionalFormPars;

    public AdditionalFormPars_COMMA (FormPar FormPar, AdditionalFormPars AdditionalFormPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AdditionalFormPars_COMMA(\n");
